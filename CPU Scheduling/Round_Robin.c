...
int main()
{
    int cpu_time[10], rem_cpu_time[10], waiting_time[10],
        turnaround_time[10], time_quantum, process[10], working_process[100];
    int on_working_time[100], n, i,j,temp, flag, counter = 0, timer,
                                                 running_job;
